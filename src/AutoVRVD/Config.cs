...
/// <summary>User configuration, persisted to %AppData%\AutoVRVD\config.json.</summary>
public sealed class Config
{
    ...
    public string DeviceName { get; set; } = "AutoVRVD";
    ...
    public bool EnsureDefaults()
    {
        ...
        if (string.IsNullOrWhiteSpace(DeviceName)) { DeviceName = "AutoVRVD"; changed = true; }
