...
/// %AppData%\AutoVRVD\logs and keeps a bounded in-memory ring of recent lines
...
public static class Log
{
    ...
    {
        Paths.EnsureCreated();
        _logFile = Path.Combine(Paths.LogsDir, $"autovrvd-{DateTime.Now:yyyyMMdd}.log");
        Info($"=== AutoVRVD started (pid {Environment.ProcessId}, {Environment.OSVersion}) ===");
    }
